...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('admin') }}" class="logo">
      ...
      <span class="logo-mini"><b>Fudu</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Fudu's Admin</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            ?> 
          <img src="{{ asset("/backend/dist/img/admin_img/".$name->image) }}" class="user-image" alt="User Image">
          <span class='hidden-xs'>{{ $name->fullname }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  {{ $name->fullname }}- Web Backend Developer
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ url('admin_profile/'.$admin_id) }}" class="btn btn-default btn-flat">Profile</a>
                </div>
                <?php } ?>

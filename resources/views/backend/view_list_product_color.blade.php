  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Quản lý Màu Sắc Sản Phẩm</li>
      </ol>
    </section>
    <a href="{{ url('add_product_color') }}">
      <input type="button"  class="btn btn-block btn-primary" style="width: 200px; margin-left: 20px; margin-top: 20px;" value="Thêm Màu Sắc Sản Phẩm">
    </a>
    <!-- Main content -->

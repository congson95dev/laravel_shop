    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      <h1 style="margin-left: 100px;">
       Chỉnh Sửa Nguyên Liệu Sản Phẩm
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('admin') }}"><i class="fa fa-dashboard"></i> Trang Chủ</a></li>
        <li class="active">Chỉnh sửa Nguyên Liệu Sản Phẩm</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-11">
          ...
          <div class="box box-primary">
           <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ url('update_product_material/'.$arr_mate->mate_id) }}">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="box-body">
                <div class="form-group">
                  ...
                  value="{{ isset($arr_mate->material_name) ? $arr_mate->material_name : '' }}">
                </div>
